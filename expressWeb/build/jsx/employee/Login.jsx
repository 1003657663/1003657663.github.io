...
var Login = React.createClass({
    ...
    render: function () {
        ...
        if (this.state.isLogin) {
            ...
            nameCom = <NameLogin {...this.props} handleWorkTypeChange={this.handleWorkTypeChange}
        ...
        return (
            <form onSubmit={this.handleSubmitStart} method="get" className="login_window">
                ...
                <Tel handleChange={this.handleTelChange} value={this.props.isUpdate?this.props.employee.telephone:""}
                     onError={this.handleError}/>
                {nameCom}
                <Password handleChange={this.handlePasswordChange}
