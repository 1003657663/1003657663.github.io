...
var EmployeeManagerComponent = React.createClass({
    ...
    getEmployeeSuccess: function (data) {
        if (this.isMounted()) {
            this.props.onDoClick(null, null, [<EmployeeListComponent onUpdate={this} siteID={this.props.siteID} data={data}/>]);
        }
    },
    addEmployee: function () {
        //跳转到注册页面直接注册员工
        ReactDOM.render(
            <Login isLogin={false} key="noLogin" siteID={this.props.siteID} onSuccess={this}/>,
                ...
                {this.state.data.map(function (data, index) {
                    return (
                        <li key={"li"+index} data-index={index} onClick={this.onLiClick}>
                            ...
                            <img data-index={index} onClick={this.onDelClick} key="delimg"
